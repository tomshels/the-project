	  ...
	  <div class="info-data" data-infodata="<?php if(isset($_SESSION['info'])){ echo $_SESSION['info']; } unset($_SESSION['info']); ?>"></div>
		...
		<div class="kotak">
			<form class="form-signin" action="proses.php" method="post" >
				<img src="img/logocs.jpg" alt="SPP Login" width="60px" height="55px" style="margin-left:25px;">

				<div style="margin-left:120px;margin-top:-35px;font-size:22px; margin-bottom:15px; color: white; text-shadow: 1px  1px 2px black">Aplikasi SPP</div>
			...
			<h5 class="copy" style="color: white; text-shadow: 1px  1px 2px black">Copyright Absen 5&copy; <?=date('Y');?></h5>
		</div>
